        ...
        <nav class="nav">
            <div>
                ...
                <div class="nav_list">
                    ...
                    <a href="../index.php?id=<?php echo $row['id'];?>" class="d-flex nav_link ">
                    ...
                    <a href="taikhoan.php?id=<?php echo $row['id'];?>" class="d-flex nav_link  active">
                        <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="currentColor"
                    ...
                    <a href="../sanpham/sanpham.php?id=<?php echo $row['id'];?>" class="d-flex nav_link">
                        <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="currentColor"
                    ...
                    <div class="login col-md-12 d-flex justify-content-center">
                        <div style="box-shadow: 0 2px 4px 0 #0000001a, 0 8px 16px 0 #0000001a;background:white;width:1200px;border-radius:8px"
                            ...
                            <a class="text-decoration-none link-dark" style="font-size:13px"
                                href="../check_acount.php?id=<?php echo $id ?>">
                                <div class="mb-3 ms-1">
