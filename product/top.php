            ...
            <div class="px-5 mt-5">
                ...
                <div class="row d-flex  px-4 mt-5">
                    <?php 
                            ...
                            $sql1 = "SELECT *, sanpham.Giaban-(sanpham.Giaban*sanpham.Tylegiamgia) as Giagiam from loaihang,sanpham where loaihang.MaLH=sanpham.MaLH and loaihang.MaLH='LH01'";
